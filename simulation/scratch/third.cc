...
int main(int argc, char *argv[])
{
	...
	for (uint32_t i = 0; i < node_num; i++){
		...
		else if (n.Get(i)->GetNodeType() == 1) //sw
		{
			...
			copy_max_size = n.Get(2)->max_copysize;
			reordering_max_size = n.Get(3)->max_reorderingsize;
			up_qlength = n.Get(2)->qlength;
			down_qlength = n.Get(3)->qlength;

			// copy_max_size_340 = n.Get(340)->max_copysize;
			// reordering_max_size_360 = n.Get(360)->max_reorderingsize;
			// up_qlength_340 = n.Get(340)->qlength;
			// copy_max_size_347 = n.Get(347)->max_copysize;
